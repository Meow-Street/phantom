...
impl Renderer {
    pub async fn new(window: Arc<Window>) -> anyhow::Result<Self> {
        ...
        // An adapter is a handle for the GPU
        ...
        // NOTE: Shader code assumes an sRGB surface texture. Using a different
    ...
    pub fn render(&mut self) -> Result<(), wgpu::SurfaceError> {
        ...
        // Create TextureView so we can control how render code interacts with the texture
        let view = output
            .texture
            .create_view(&wgpu::TextureViewDescriptor::default());

        // Create command encoder to create the list of commands to send to the GPU
